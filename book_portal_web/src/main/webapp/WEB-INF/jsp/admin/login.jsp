...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="../../../images/309411.jpg" alt="第一张">
        </div>
        <div class="item">
            <img src="../../../images/321795.jpg" alt="第二张">
        </div>
        <div class="item">
            <img src="../../../images/323409.jpg" alt="第三张">
        </div>
        <div class="item">
            <img src="../../../images/324470.jpg" alt="第四张">
        </div>
            ...
            if($("#adminId").val()==''&&$("#passwd").val()==''){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                       // alert("state:"+data.state.trim());
                        if(data.status == "400") {
                            $("#info").text(data.msg);
                        }
                        if(data.status == "200"){
                            $("#info").text("提示:登陆成功，跳转中...");
                            window.location.href="/admin/main?admin_token="+data.data;
                        }
                    }
                });
            }
